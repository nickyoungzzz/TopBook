...
data class LifeTopic(
	var topicId: Long, var abstract: String, var avatarUrl: String, var createTime: String,
...
data class LifeTopicComment(
	var viewpointId: Long, var topicId: Long, val content: String, var totalLike: Int,
